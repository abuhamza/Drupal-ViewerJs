...
INSTALLATION
------------
1. Download ViewerJs (or clone the master branch) here: https://github.com/Strae/Viewer.js
2. Place it into your library folder, usually sites/all/libraries, and rename it viewerjs
  (lowercase it)
3. Just check that file libraries/viewerjs/Viewer.js  exists.
4. Install the module in Drupal (admin > modules or via drush)
